...
//    }
     ...
     *
     * @param sArr    The bytes to convert. If null or length 0 an
     ...
     *
     * @param sArr The source array. null or length 0 will return
     *             an empty array.
...
//    }
     ...
     * 加密字符串
     *
     * @param sArr 要加密byte数组
     * @return 加密后的字符串
     */
    public static String encodeToString(String sArr) {

        // Reuse char[] since we can't create a String incrementally anyway and

        // StringBuffer/Builder would be slower.

        return new String(encodeToChar(sArr.getBytes(), devLineSep));
     ...
     * @return 解密后的字符串
     */
    public static String decodeToString(String sArr) {

        // Reuse char[] since we can't create a String incrementally anyway and

        // StringBuffer/Builder would be slower.

        return new String(decode(sArr));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Base64Util.encodeToString("5CC9D9B48EFCF2FDB766BFB00E08EEDF".getBytes()));
