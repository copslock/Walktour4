...
public class ClaimedSurveyTaskFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_claimed_survey_task, container, false);
        ...
        mRecyclerAdapter.replaceList(DataProvider.getInstance().getSurveyTaskList(getActivity(),SurveyTask.STATE_CLAIMED));
