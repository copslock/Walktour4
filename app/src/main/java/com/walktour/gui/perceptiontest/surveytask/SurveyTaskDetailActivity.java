...
public class SurveyTaskDetailActivity extends AppCompatActivity {

    public static final String EXTRA_SURVEY_TASK = "extra_survey_task";
    private static final String TAG = "SurveyTaskDetailActivity";
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mProgressDialog.isShowing()) {
                ...
                ToastUtil.showShort(SurveyTaskDetailActivity.this, "勘测任务领取成功!");
                EventBus.getDefault().post(new RefreshDataEvent());
                mSurveyTask.setState(SurveyTask.STATE_CLAIMED);
                DBManager.getInstance(SurveyTaskDetailActivity.this).update(mSurveyTask);
                finish();
            }
        }
    };
