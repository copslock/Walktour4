...
public class SurveyTaskFinishingActivity extends AppCompatActivity {
...
//        setSupportActionBar(this.mToolbar);
        setToolbarTitle("勘测任务");

        if (mFragments.isEmpty()) {
            mFragments.add(new UnFinishedSurveyTaskFragment());
            mFragments.add(new FinishedSurveyTaskFragment());
        }
        if (mTitles.isEmpty()) {
            mTitles.add("未完成");
            mTitles.add("已完成");
