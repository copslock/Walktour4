...
public class MessageDaoManager {
     ...
     * 唯一实例
     */
    private static MessageDaoManager sInstance;
    /**
     * 数据库名称
     */
    ...
    private MessageDaoManager(Context context) {
     ...
     * @return 唯一实例
     */
    public static MessageDaoManager getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new MessageDaoManager(context.getApplicationContext());
        }
        return sInstance;
    }
