 ...
 * DNS统计界面
 */
public class TotalSpeedTestView  extends BasicTotalView {
	
	private static String tag = "TotalSpeedTestView";
	private boolean isRegisterReceiver = false;

	public TotalSpeedTestView(Context context) {
		super(context);
	}
	
	public TotalSpeedTestView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected Bitmap CreateTable(Canvas cv) {
		...
		String paraname;
		/* 第一行 */
		paraname = getContext().getString(R.string.total_speedtest);
	...
	private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			if (intent.getAction().equals(TotalDataByGSM.TotalResultToPicture)) {
				...
				TotalSpeedTestView.this.buildDrawingCache();
				UtilsMethod.SaveBitmapToFile(
						TotalSpeedTestView.this.getDrawingCache(), path);
			} else {
				invalidate();
			}
		}
