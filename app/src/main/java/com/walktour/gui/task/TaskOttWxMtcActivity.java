 ...
 * @author czc
 */
public class TaskOttWxMtcActivity extends BaseTaskActivity {
     ...
     * ott 测试子任务的类型
     */
    private WalkStruct.TaskType mCurrentTaskType = WalkStruct.TaskType.WeCallMtc;
    ...
    private void initView() {
        setContentView(R.layout.task_wx_mtc);
