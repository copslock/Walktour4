 ...
 * @author czc
 */
public class TaskOttWhatsAppMtcActivity extends BaseTaskActivity {
     ...
     * ott 测试子任务的类型
     */
    private WalkStruct.TaskType mCurrentTaskType = WalkStruct.TaskType.WhatsAppMtc;
    ...
    private void initView() {
        setContentView(R.layout.task_whatsapp_mtc);
