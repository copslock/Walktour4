 ...
 * @author czc
 */
public class TaskOttWeChatActivity extends BaseTaskActivity implements OnItemSelectedListener {
     ...
     * ott 测试子任务的类型
     */
    private WalkStruct.TaskType mCurrentTaskType = WalkStruct.TaskType.WeChat;
    ...
    private void initView() {
        setContentView(R.layout.task_weixin);
        ButterKnife.bind(this);

        // 设置标题
        mTaskTitle.setText(mCurrentTaskType.getShowName(this));
    ...
    public void saveTestTask() {
        ...
        // 依据标记区分用户名的编辑
        mModel.setTaskName(mCurrentTaskType.getShowName(this));
