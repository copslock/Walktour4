 ...
 * @author czc
 */
public class TaskOttFacebookActivity extends BaseTaskActivity implements OnItemSelectedListener {
     ...
     * ott 测试子任务的类型
     */
    private WalkStruct.TaskType mCurrentTaskType = WalkStruct.TaskType.Facebook_Ott;
    ...
    private void initView() {
        setContentView(R.layout.task_fb);
        ...
        ArrayAdapter<String> pictureTypeAdapter = new ArrayAdapter<>(this, R.layout.simple_spinner_custom_layout, new String[]{"3M"});
