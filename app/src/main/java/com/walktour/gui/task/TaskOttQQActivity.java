 ...
 * @author czc
 */
public class TaskOttQQActivity extends BaseTaskActivity implements OnItemSelectedListener {
     ...
     * ott 测试子任务的类型
     */
    private WalkStruct.TaskType mCurrentTaskType = WalkStruct.TaskType.QQ;
    ...
    private void initView() {
        setContentView(R.layout.task_qq);
