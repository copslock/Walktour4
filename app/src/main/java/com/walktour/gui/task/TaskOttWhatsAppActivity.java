 ...
 * @author czc
 */
public class TaskOttWhatsAppActivity extends BaseTaskActivity implements OnItemSelectedListener {
     ...
     * ott 测试子任务的类型
     */
    private WalkStruct.TaskType mCurrentTaskType = WalkStruct.TaskType.WhatsAppChat;
    ...
    private void initView() {
        setContentView(R.layout.task_whatsapp);
