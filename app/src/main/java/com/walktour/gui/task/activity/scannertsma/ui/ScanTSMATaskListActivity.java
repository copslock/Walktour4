 ...
 * @author jinfeng.xie
 */
public class ScanTSMATaskListActivity extends BasicActivity implements OnItemClickListener, ScanTaskAdapter.OnItemClickListener {
//    @Override
...
//    }
    ...
    protected void onResume() {
        new getDateList().executeOnExecutor(Executors.newCachedThreadPool());    //获取分析数据
        super.onResume();
    }


    private void showDialog() {
        ftpDialog = new ProgressDialog(ScanTSMATaskListActivity.this);
...
//				ftpDialog.cancel();
        ...
        protected void onPostExecute(Object result) {
            ...
            if (scanTaskAdapter == null) {
                scanTaskAdapter = new ScanTaskAdapter(ScanTSMATaskListActivity.this, (ArrayList<ScanTaskModel>) result);
...
//					mListView.setPinnedHeaderView(LayoutInflater.from(ScanTaskListActivity.this).inflate(R.layout.scan_item_section, mListView, false));
            ...
            scanTaskAdapter.setOnItemClickListener(ScanTSMATaskListActivity.this);
    ...
    private Intent getItentType(int schemaTaskType) {
        ...
        switch (schemaTaskType) {
            case TestSchemaType.CWTEST:
                intent = new Intent(ScanTSMATaskListActivity.this, ScanTaskCwActivity.class);
                break;
            case TestSchemaType.COLORCODETEST:
                intent = new Intent(ScanTSMATaskListActivity.this, ScanTaskColorCodeActivity.class);
                break;
            case TestSchemaType.PILOTTEST:
                intent = new Intent(ScanTSMATaskListActivity.this, ScanTaskPilotActivity.class);
                break;
            case TestSchemaType.LTEPILOTTEST:
                intent = new Intent(ScanTSMATaskListActivity.this, ScanTaskLtePilotActivity.class);
                break;
            case TestSchemaType.SPECTURM:
                intent = new Intent(ScanTSMATaskListActivity.this, ScanTaskSpecturmActivity.class);
                break;
                case TestSchemaType.BLIND:
                    intent=new Intent(ScanTSMATaskListActivity.this,ScanTaskBlindActivity.class);
            default:
                break;
        }
        return intent;
