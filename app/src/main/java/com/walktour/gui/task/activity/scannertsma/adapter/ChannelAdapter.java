...
//	private OnItemClickListener mOnItemClickListener;
    private List<Channel> channelModels;

    List<Channel> deleteModels = new ArrayList<Channel>();
     ...
     * @param mContext
      */
    public ChannelAdapter(Context mContext, List<Channel> channelModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Channel channelModel = getItem(position);

//        boolean isEqual = (channelModel.getStartChannel() == channelModel.getEndChannel());

        mHolder.channel_txt.setText(""+channelModel.getChannel());
     ...
     *
      */
    private void showDeleteDialog(final Channel channelModel) {
