package com.walktour.gui.newmap.metro;
...
public class MetroStationOperatePopWindow implements OnCheckedChangeListener {
    /**
     * 日志标识
     */
...
//    private boolean isShow = false;
    ...
    public MetroStationOperatePopWindow(View parent, Context context, MetroStation station) {
        this.mParent = parent;
        this.mContext = context;
        this.mFactory = MetroFactory.getInstance(context);
