...
public class HspaPlus extends BasicActivity {
    
    private ScrollLayout scrollLayout;
    
	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.map_hspa_plus_view);
        
        scrollLayout = (ScrollLayout) findViewById(R.id.srooll_layout);
        LayoutParams layoutParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        
        View hspaPlusView1= new HspaPlusView(this, 1);
        View hspaPlusView2= new HspaPlusView(this, 2);
        scrollLayout.addView(hspaPlusView1, layoutParams);
        scrollLayout.addView(hspaPlusView2, layoutParams);
