package com.walktour.gui.map.googlemap.kml.constants;
...
public interface PoiConstants {
	...
	public static final String STAT_deleteAllTrack_1 = "DELETE FROM trackpoints";
	public static final String STAT_deleteAllTrack_2 = "DELETE FROM tracks";
	...
	public static final String SQL_UPDATE_1_5 = "INSERT INTO 'points' (pointid, name, descr, lat, lon, alt, hidden, categoryid, pointsourceid, iconid) SELECT pointid, name, descr, lat, lon, alt, hidden, categoryid, pointsourceid, "
			+ R.drawable.iconmarker + " FROM 'points_45392250';";
