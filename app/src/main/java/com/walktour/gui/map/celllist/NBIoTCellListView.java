 ...
 *
 */
public class NBIoTCellListView extends BaseCellListView {

	public NBIoTCellListView(Context context) {
		super(context, "NBIoT", BaseStation.NETTYPE_NBIOT, -40, -141);
	}

	public NBIoTCellListView(Context context, AttributeSet attrs) {
		super(context, attrs, "NBIoT", BaseStation.NETTYPE_NBIOT, -40, -141);
	}
