 ...
 *
 */
public class HighSpeedRailView extends BaseView {
	...
	public HighSpeedRailView(Context context, String type) {
		super(context, type);
	...
	private void init() {
		...
		rightListView = (ListView) mView.findViewById(R.id.left_listview);
		currentLineLists = mDBManager
				.getRecordTestInfoLines(ApplicationModel.getInstance().getSelectScene().getSceneTypeId());
