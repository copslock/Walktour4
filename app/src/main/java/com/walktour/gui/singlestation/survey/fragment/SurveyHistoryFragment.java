...
import com.walktour.gui.singlestation.survey.component.DaggerSurveyHistoryFragmentComponent;
...
public class SurveyHistoryFragment extends BaseListFragment<SurveyStationInfo> {
    /**
     * 日志标识
     */
    private static final String TAG = "SurveyHistoryFragment";
    /**
     * 基站列表
     */
     ...
     */
    @Inject
    SurveyHistoryFragmentPresenter mPresenter;

    public SurveyHistoryFragment() {
        super(R.string.single_station_survey_history, R.layout.fragment_list_base, R.layout.fragment_single_station_survey_history_list_row);
    }
    ...
    void jumpToNextActivity(int position) {
        this.mPresenter.jumpToSurveyEditActivity(this.getItem(position));
    }
    ...
    protected void setupFragmentComponent() {
        DaggerSurveyHistoryFragmentComponent.builder().surveyHistoryFragmentModule(new SurveyHistoryFragmentModule(this)).build().inject(this);
    }
     ...
     * 存放控件 的ViewHolder
     */
    public class ViewHolder extends BaseHolder<SurveyStationInfo> {
        /**
         * 基站图片
         */
        ...
        @Override
        public void setData(int position, SurveyStationInfo data) {
            StationInfo stationInfo = data.getStationInfo();
            this.showStationImage(stationInfo);
            this.mCode.setText(String.valueOf(stationInfo.getENodeBID()));
            this.mName.setText(stationInfo.getName());
            this.mAddress.setText(stationInfo.getAddress());
            this.mDistance.setText(stationInfo.getDistance());
            this.showTestStatus(stationInfo);
        }
