 ...
 * @date 2019/3/15
 */
public class WcdmaParamFilter implements IParamFilter {
    ...
    public int getNetType() {
        return WalktourConst.NetWork.WCDMA;
    }
        ...
        if (station.netType == getNetType()) {
            ...
            for (BaseStationDetail detail : details) {
                ...
                try {
                    ...
                    String psc = detail.psc;
                    param1 = Integer.parseInt(StringUtil.isEmpty(psc) ? "" : psc);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
                int param2 = 0;
                try {
                    String uarfcn = detail.uarfcn;
                    param2 = Integer.parseInt(StringUtil.isEmpty(uarfcn) ? "" : uarfcn);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
