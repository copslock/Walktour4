 ...
 * @date 2019/3/15
 */
public class NbParamFilter implements IParamFilter {
    ...
    public int getNetType() {
        return WalktourConst.NetWork.NB_IoT;
    }
        ...
        if (station.netType == getNetType()) {
            ...
            for (BaseStationDetail detail : details) {
                ...
                try {
                    ...
                    String pci = detail.pci;
                    param1 = Integer.parseInt(StringUtil.isEmpty(pci) ? "" : pci);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
                int param2 = 0;
                try {
                    String earfcn = detail.earfcn;
                    param2 = Integer.parseInt(StringUtil.isEmpty(earfcn) ? "" : earfcn);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
