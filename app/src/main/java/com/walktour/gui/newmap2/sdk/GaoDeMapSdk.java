 ...
 */
public class GaoDeMapSdk implements IMapSdk,
        ...
        , DistanceSearch.OnDistanceSearchListener, AMap.InfoWindowAdapter {
    private String ZOOM_SIZE_SHARE = "zoom_size_share";
    private static final String TAG = "GaoDeMapSdk";
    /**
     * 地图View控件
     */
    ...
    public GaoDeMapSdk(Context context, Bundle savedInstanceState) {
 ...
 */
    ...
    public int getLayoutId() {
        return R.layout.map_gaode_main_activity;
    }
