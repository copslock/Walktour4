 ...
 * @date 2019/3/15
 */
public class GsmParamFilter implements IParamFilter {
    ...
    public int getNetType() {
        return WalktourConst.NetWork.GSM;
    }
        ...
        if (station.netType == getNetType()) {
            ...
            for (BaseStationDetail detail : details) {
                ...
                try {
                    ...
                    String cellId = detail.cellId;
                    param1 = Integer.parseInt(StringUtil.isEmpty(cellId) ? "" : cellId);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
                int param2 = 0;
                try {
                    String bsic = detail.bsic;
                    param2 = Integer.parseInt(StringUtil.isEmpty(bsic) ? "" : bsic);
                } catch (NumberFormatException e) {
                    e.printStackTrace();
                }
