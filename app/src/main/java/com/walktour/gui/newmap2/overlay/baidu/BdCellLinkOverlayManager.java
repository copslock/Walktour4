 ...
 * @date 2018/6/12
 */
public class BdCellLinkOverlayManager extends BaseOverlayManager {
    private static final String TAG = BdCellLinkOverlayManager.class.getSimpleName();
    /**
     * 参数
     */
    ...
    public BdCellLinkOverlayManager(Context context) {
        super(context);
    ...
    public boolean addOverlay(Object... obj) {
        ...
        if (latLng != null) {
            LatLng ll = BaiduMapUtil.convert(latLng.getLatitude(), latLng.getLongitude());
    ...
    private void drawCellLink(BaseStationDetail detail, LatLng currentLocation, LatLng stationLoaction, int color, int strokeWidth, int angle) {
        ...
        OverlayOptions ooPolyline = new PolylineOptions()
                ...
                .zIndex(9)
                .points(lineList);
        getMapControllor().addOverlay(ooPolyline);
        ...
        getMapControllor().addOverlay(textOption);
    }
