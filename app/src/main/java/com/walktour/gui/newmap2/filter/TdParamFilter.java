 ...
 * @date 2019/3/15
 */
public class TdParamFilter implements IParamFilter {
    ...
    public int getNetType() {
        return WalktourConst.NetWork.TDSDCDMA;
    }
        ...
        if (station.netType == getNetType()) {
            ...
            for (BaseStationDetail detail : details) {
                ...
                try {
                    ...
                    String cpi = detail.cpi;
                    param1 = Integer.parseInt(StringUtil.isEmpty(cpi) ? "" : cpi);
