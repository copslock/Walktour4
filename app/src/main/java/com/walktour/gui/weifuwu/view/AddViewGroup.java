...
public class AddViewGroup extends ViewGroup {
	 ...
	 * @param defStyle
	 */
	public AddViewGroup(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs
	 */
	public AddViewGroup(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	@Override
