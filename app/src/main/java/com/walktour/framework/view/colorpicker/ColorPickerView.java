...
public class ColorPickerView extends View {
    ...
    /**
     * 边框大小,surrounding all color panels
     */
    ...
    private void init(AttributeSet attrs) {
        ...
        mShowAlphaPanel = a.getBoolean(R.styleable.ColorPickerView_alphaChannelVisible,
                false);
        mAlphaSliderText = a.getString(R.styleable.ColorPickerView_alphaChannelText);
        mSliderTrackerColor = a.getColor(R.styleable.ColorPickerView_colorPickerSliderColor,
                0xFFBDBDBD);
        mBorderColor = a.getColor(R.styleable.ColorPickerView_colorPickerBorderColor,
                0xFF6E6E6E);
        a.recycle();
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        if (mSatValBackgroundCache == null
            ...
            if (mSatValBackgroundCache.bitmap == null) {
                mSatValBackgroundCache.bitmap = Bitmap.createBitmap((int) rect.width(),
                        (int) rect.height(),
                        Config.ARGB_8888);
            }
            ...
            if (mSatValBackgroundCache.canvas == null) {
                mSatValBackgroundCache.canvas = new Canvas(
            ...
            mSatValBackgroundCache.canvas.drawRect(0,
                    0,
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        if (mHueShader == null) {
            ...
            mHueShader = new LinearGradient(0, 0, 0, rect.height(),
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                mStartTouchPoint = new Point((int) event.getX(),
                        (int) event.getY());
...
//    }
    ...
    private void setUpSatValRect() {
        ...
        float right = dRect.right - BORDER_WIDTH_PX - PANEL_SPACING
                - HUE_PANEL_WIDTH;
