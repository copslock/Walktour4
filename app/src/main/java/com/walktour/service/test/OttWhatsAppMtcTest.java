...
import com.walktour.service.test.MultipleAppEvent.WhatsAppMtcEventor;
 ...
 * @author czc
 */
public class OttWhatsAppMtcTest extends TestTaskService {

    private static final String TAG = "OttWhatsAppMtcTest";
    /**
     * 执行结束时的结果
     */
