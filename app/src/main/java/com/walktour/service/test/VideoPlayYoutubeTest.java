...
import com.walktour.service.dmplayer.VideoPlayYoutubeActivity;
...
public class VideoPlayYoutubeTest extends VideoPlayTestBase implements DMPlayerAPI.EventListener {
	/** 日志标识 */
	private static final String TAG = "VideoPlayYoutubeTest";
	...
	private void showVideoPlayActivity() {
		try {
			...
			Intent intent = new Intent(getBaseContext(), VideoPlayYoutubeActivity.class);
	...
	private void regeditBroadcast() {
		...
		intentFilter.addAction(BROADCAST_YOUTUBE_INIT_FAILED);
	...
	private class MyReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			} else if (intent.getAction().equals(BROADCAST_YOUTUBE_INIT_FAILED)) {
				DMPlayerAPI.YoutubeInitFailedInfo info = (DMPlayerAPI.YoutubeInitFailedInfo) intent.getSerializableExtra("Info");
				onInitFailed(info, realTime);
