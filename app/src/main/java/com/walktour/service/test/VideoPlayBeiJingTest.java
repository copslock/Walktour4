...
public class VideoPlayBeiJingTest extends VideoPlayTestBase implements DMPlayerAPI.EventListener {
	/** 日志标识 */
	private static final String TAG = "VideoPlayBeiJingTest";
	...
	public void onDestroy() {
		...
		UtilsMethod.killProcessByPname("com.walktour.service.test.VideoPlayBeiJingTest", false);
