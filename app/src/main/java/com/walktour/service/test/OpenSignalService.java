...
public class OpenSignalService extends TestTaskService {
    private static final String TAG = "OpenSignalService";
    private final int TIMER_CHANG = 55;    //时间刷新计时器
    //网速测试业务ID
    private static final int SPEEDTEST_TEST = 300;
...
//	private static final int SPEEDTEST_STOP_TEST				= 1006; //停止业务(ID不可变)
    ...
    private TaskOpenSignalModel taskModel;
        ...
        public void stopTask(boolean isTestInterrupt, int dropResion) throws RemoteException {
            ...
            if ((isTestInterrupt || dropResion != DropReason.NORMAL.getReasonCode()) && !isStop) {
                ...
                if (step > 1 && step < 3) {//在连接阶段
                    displayEvent(DataTaskEvent.SPEEDTEST_ConnectSockFailed.toString());
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_CONNECTSOCKFAILED, System.currentTimeMillis() * 1000);
                    ...
                    EventBytes.Builder(getBaseContext(), RcuEventCommand.OPENSIGNAL_FAIL)
                            .addInteger(1)
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        taskModel = (TaskOpenSignalModel) super.taskModel;
                    ...
                    switch (msg.what) {
                        ...
                        case TEST_STOP:
                            ...
                            if (taskModel != null) {
                                ...
                                OpenSignalService.this.onDestroy();
                            }
                            break;
                        case TIMER_CHANG:
                            timerChange();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (aMsg.event_id) {
                ...
                case SPEEDTEST_CONNECT_START:
                    ...
                    strQos = aMsg.data;
                    msgStr = DataTaskEvent.SPEEDTEST_SockConnecting.toString();
                    displayEvent(msgStr);
                    EventBytes.Builder(getBaseContext(), RcuEventCommand.OPENSIGNAL_SOCKCONNECTING)
                            .addCharArray(taskModel.getCountry().toCharArray(), 64)
                            .addCharArray(taskModel.getCity().toCharArray(), 64)
                ...
                case SPEEDTEST_CONNECT_SUCCESS:
                    ...
                    msgStr = DataTaskEvent.SPEEDTEST_ConnectSockSucc.toString();
                    displayEvent(msgStr);
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_CONNECTSOCKSUCC, aMsg.getRealTime());
                ...
                case SPEEDTEST_CONNECT_FAILED:
                    ...
                    msgStr = DataTaskEvent.SPEEDTEST_ConnectSockFailed.toString();
                    displayEvent(msgStr);
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_CONNECTSOCKFAILED, aMsg.getRealTime());
                ...
                case SPEEDTEST_PING_START:
                    ...
                    isRunning = true;
                    msgStr = DataTaskEvent.SPEEDTEST_Ping_Strart.toString();
                    displayEvent(msgStr);
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_PING_STRART, aMsg.getRealTime());
                ...
                case SPEEDTEST_PING_SUCCESS:
                    ...
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_PING_SUC, aMsg.getRealTime(), delay);
                    msgStr = String.format(DataTaskEvent.SPEEDTEST_Ping_Suc.toString(), delay);
                    displayEvent(msgStr);
                ...
                case SPEEDTEST_DOWNLOAD_START:
                    ...
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_DL_STRART, aMsg.getRealTime());
                ...
                case SPEEDTEST_DOWNLOAD_SUCCESS:
                    ...
                    EventBytes.Builder(getBaseContext(), RcuEventCommand.OPENSIGNAL_DL_SUC)
                ...
                case SPEEDTEST_UPLOAD_START:
                    ...
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_UL_START, aMsg.getRealTime());
                    avgSpeed.clear();
                    speedTime = startTime;
                    lastBytes = 0;
                    break;
                ...
                case SPEEDTEST_UPLOAD_SUCCESS:
                    ...
                    EventBytes.Builder(getBaseContext(), RcuEventCommand.OPENSIGNAL_UL_SUC)
                            .addDouble(up_speed)
                ...
                case SPEEDTEST_FAILED:
                    ...
                    displayEvent(msgStr);
                    //writeRcuEvent(RcuEventCommand.OPENSIGNAL_FAIL, type, reason, actualSize);
                ...
                case SPEEDTEST_FINISH:
                    ...
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_FINISH, aMsg.getRealTime());
                    //报告Pioneer，任务成功
                    sendMsgToPioneer(",bSuccess=1");
                    break;
                case SPEEDTEST_QUIT:
                    LogUtil.w(TAG, "recv SPEEDTEST_QUIT");
                    writeRcuEvent(RcuEventCommand.OPENSIGNAL_SOCKETDISCONNECTED, aMsg.getRealTime());
    ...
    protected void startTest() {
        ...
        String args = "-m opensignal -z " + AppFilePathUtil.getInstance().getAppConfigDirectory();
        ...
        boolean flag=aIpc2Jni.run_client(client_path, args);
        LogUtil.w(TAG, "flag="+flag);
    }
