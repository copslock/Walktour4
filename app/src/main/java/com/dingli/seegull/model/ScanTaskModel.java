...
public abstract class ScanTaskModel {
	...
	public ArrayList<ChannelModel> channelLists = new ArrayList<ChannelModel>();
	
	public ArrayList<ChannelModel> getChannelLists() {
		return channelLists;
	}
	public void setChannelLists(ArrayList<ChannelModel> channelLists) {
	...
	public abstract void initChannelList(ArrayList<ChannelModel> channelLists);
