...
public class AudioDataStereo {
	...
	{
		Reset();
		int result = internalGetAudioDataOneStereoFile(filename);
		return result;
	}
	
	public float[] samplesLeft = null;
	public float[] samplesRight = null;
	public int nrChannels = 0; 
	...
	private native int internalGetAudioDataOneStereoFile(String filename);
